...
#
# Generated by Vivado on Thu Jan 06 15:15:40 +0800 2022
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_pll xil_defaultlib.clk_pll xil_defaultlib.glbl -log elaborate.log
}
