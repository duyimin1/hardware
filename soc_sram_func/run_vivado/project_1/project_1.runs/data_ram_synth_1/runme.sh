...
HD_PWD='D:/hardware proj/CO-lab-material-CQU-2021/CO-lab-material-CQU-2021/test/func_test_v0.01_n4ddr/soc_sram_func/run_vivado/project_1/project_1.runs/data_ram_synth_1'
cd "$HD_PWD"
